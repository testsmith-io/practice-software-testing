...
const routes: Routes = [
  ...
  {
    path: 'brands/edit/:id',
    component: BrandsAddEditComponent,
  ...
  },
  {
    ...
    component: AverageSalesMonthComponent,
    canActivate: [AdminAuthGuard],
    data: {title: 'Average Sales Per Month'}
  },
  {
    path: 'reports/average-sales-per-week',
    component: AverageSalesWeekComponent,
    canActivate: [AdminAuthGuard],
    data: {title: 'Average Sales Per Week'}
  },
];
