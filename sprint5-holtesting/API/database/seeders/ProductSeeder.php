...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([[
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Kladivo',
            'description' => 'Univerzální kladivo pro běžné práce v dílně i na stavbě.',
            'stock' => 25,
            'price' => 11.90,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Hammer')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Pila',
            'description' => 'Ruční pila na dřevo pro přesné řezy a stavební práce.',
            'stock' => 20,
            'price' => 18.50,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Hand Saw')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Šroubovák',
            'description' => 'Kvalitní šroubovák pro montáž a opravy drobných spojů.',
            'stock' => 40,
            'price' => 6.25,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Screwdriver')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Klíč',
            'description' => 'Stavitelný klíč pro matice a šrouby různých velikostí.',
            'stock' => 30,
            'price' => 14.80,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Wrench')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Kleště',
            'description' => 'Univerzální kleště pro držení, ohýbání a stříhání drátu.',
            'stock' => 28,
            'price' => 10.40,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Pliers')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Vrtačka',
            'description' => 'Elektrická vrtačka pro vrtání a utahování ve dřevě a kovu.',
            'stock' => 15,
            'price' => 89.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Drill')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Dláto',
            'description' => 'Dláto na dřevo pro truhláře a jemné tesařské práce.',
            'stock' => 22,
            'price' => 16.30,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Chisels')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Sekera',
            'description' => 'Sekera na štípání dřeva a hrubé tesařské úpravy.',
            'stock' => 12,
            'price' => 42.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Hand Saw')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Vodováha',
            'description' => 'Vodováha pro kontrolu vodorovnosti a svislosti při montáži.',
            'stock' => 35,
            'price' => 9.99,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Measures')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Svinovací metr',
            'description' => 'Kompaktní svinovací metr s přesnou stupnicí pro každodenní měření.',
            'stock' => 50,
            'price' => 7.49,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Measures')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Brusný papír',
            'description' => 'Sada brusného papíru pro ruční i strojové broušení povrchů.',
            'stock' => 60,
            'price' => 4.95,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Sander')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Odlamovací nůž',
            'description' => 'Bezpečný odlamovací nůž pro řezání kartonu, fólií a lehkých materiálů.',
            'stock' => 45,
            'price' => 5.60,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Measures')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Svěrka',
            'description' => 'Robustní svěrka pro fixaci obrobků při vrtání a broušení.',
            'stock' => 18,
            'price' => 24.90,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Workbench')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Žebřík',
            'description' => 'Hliníkový žebřík pro práce ve výšce v domě i na zahradě.',
            'stock' => 8,
            'price' => 79.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Workbench')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Lopata',
            'description' => 'Lopata na zeminu, štěrk a stavební materiál.',
            'stock' => 14,
            'price' => 22.50,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Workbench')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Hrábě',
            'description' => 'Zahradní hrábě na úpravu půdy a sběr listí.',
            'stock' => 16,
            'price' => 15.75,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Workbench')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Kolečko',
            'description' => 'Stavební kolečko pro přepravu sypkých materiálů a nářadí.',
            'stock' => 6,
            'price' => 68.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Storage Solutions')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Motorová pila',
            'description' => 'Motorová pila pro řezání dřeva a stromů s vysokým výkonem.',
            'stock' => 7,
            'price' => 249.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Saw')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Palice',
            'description' => 'Těžká palice pro bourání a práci s tvrdými materiály.',
            'stock' => 10,
            'price' => 38.00,
            'brand_id' => DB::table('brands')->where('name', '=', 'ForgeFlex Tools')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Hammer')->first()->id,
            ...
            'id' => Str::ulid()->toBase32(),
            'name' => 'Nástrčný klíč',
            'description' => 'Sada nástrčných klíčů pro utahování matic v těžko dostupných místech.',
            'stock' => 20,
            'price' => 31.20,
            'brand_id' => DB::table('brands')->where('name', '=', 'MightyCraft Hardware')->first()->id,
            'category_id' => DB::table('categories')->where('name', '=', 'Wrench')->first()->id,
