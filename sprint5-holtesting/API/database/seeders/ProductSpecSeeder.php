...
class ProductSpecSeeder extends Seeder
{
    public function run(): void
    {
        $specs = [
            ...
            'Vrtačka' => [
                ['spec_name' => 'Weight', 'spec_value' => '1800', 'spec_unit' => 'g'],
                ['spec_name' => 'Voltage', 'spec_value' => '230', 'spec_unit' => 'V'],
                ['spec_name' => 'Chuck Size', 'spec_value' => '13', 'spec_unit' => 'mm'],
                ['spec_name' => 'Max Power', 'spec_value' => '750', 'spec_unit' => 'W'],
                ['spec_name' => 'Speed', 'spec_value' => '2800', 'spec_unit' => 'rpm'],
                ['spec_name' => 'Warranty', 'spec_value' => '2', 'spec_unit' => 'years'],
            ],
            'Dláto' => [
                ['spec_name' => 'Weight', 'spec_value' => '180', 'spec_unit' => 'g'],
            ...
            'Sekera' => [
                ['spec_name' => 'Weight', 'spec_value' => '1800', 'spec_unit' => 'g'],
                ['spec_name' => 'Handle Length', 'spec_value' => '700', 'spec_unit' => 'mm'],
                ['spec_name' => 'Material', 'spec_value' => 'Forged Steel', 'spec_unit' => null],
                ['spec_name' => 'Handle Material', 'spec_value' => 'Hickory Wood', 'spec_unit' => null],
                ['spec_name' => 'Warranty', 'spec_value' => '2', 'spec_unit' => 'years'],
            ],
            'Vodováha' => [
                ['spec_name' => 'Length', 'spec_value' => '600', 'spec_unit' => 'mm'],
                ['spec_name' => 'Material', 'spec_value' => 'Aluminum', 'spec_unit' => null],
                ['spec_name' => 'Vials', 'spec_value' => '3', 'spec_unit' => null],
                ['spec_name' => 'Warranty', 'spec_value' => '1', 'spec_unit' => 'years'],
            ],
            'Svinovací metr' => [
                ['spec_name' => 'Length', 'spec_value' => '5', 'spec_unit' => 'm'],
                ['spec_name' => 'Width', 'spec_value' => '25', 'spec_unit' => 'mm'],
                ['spec_name' => 'Material', 'spec_value' => 'Steel Tape', 'spec_unit' => null],
                ['spec_name' => 'Warranty', 'spec_value' => '1', 'spec_unit' => 'years'],
            ],
            'Brusný papír' => [
                ['spec_name' => 'Grit', 'spec_value' => '120', 'spec_unit' => null],
                ['spec_name' => 'Sheet Size', 'spec_value' => '230x280', 'spec_unit' => 'mm'],
                ['spec_name' => 'Quantity', 'spec_value' => '10', 'spec_unit' => 'sheets'],
                ['spec_name' => 'Backing', 'spec_value' => 'Paper', 'spec_unit' => null],
            ],
            'Odlamovací nůž' => [
                ['spec_name' => 'Weight', 'spec_value' => '80', 'spec_unit' => 'g'],
                ['spec_name' => 'Blade Width', 'spec_value' => '18', 'spec_unit' => 'mm'],
                ['spec_name' => 'Segments', 'spec_value' => '8', 'spec_unit' => null],
                ['spec_name' => 'Material', 'spec_value' => 'Stainless Steel', 'spec_unit' => null],
            ],
            'Svěrka' => [
                ['spec_name' => 'Jaw Opening', 'spec_value' => '100', 'spec_unit' => 'mm'],
                ['spec_name' => 'Throat Depth', 'spec_value' => '80', 'spec_unit' => 'mm'],
                ['spec_name' => 'Material', 'spec_value' => 'Cast Iron', 'spec_unit' => null],
                ['spec_name' => 'Warranty', 'spec_value' => '2', 'spec_unit' => 'years'],
            ],
            'Žebřík' => [
                ['spec_name' => 'Height', 'spec_value' => '3.0', 'spec_unit' => 'm'],
                ['spec_name' => 'Rungs', 'spec_value' => '11', 'spec_unit' => null],
                ['spec_name' => 'Material', 'spec_value' => 'Aluminum', 'spec_unit' => null],
                ['spec_name' => 'Max Load', 'spec_value' => '150', 'spec_unit' => 'kg'],
            ],
            'Lopata' => [
                ['spec_name' => 'Handle Length', 'spec_value' => '1200', 'spec_unit' => 'mm'],
                ['spec_name' => 'Blade Width', 'spec_value' => '220', 'spec_unit' => 'mm'],
                ['spec_name' => 'Material', 'spec_value' => 'Steel', 'spec_unit' => null],
            ],
            'Hrábě' => [
                ['spec_name' => 'Width', 'spec_value' => '400', 'spec_unit' => 'mm'],
                ['spec_name' => 'Tines', 'spec_value' => '14', 'spec_unit' => null],
                ['spec_name' => 'Handle Length', 'spec_value' => '1500', 'spec_unit' => 'mm'],
            ],
            'Kolečko' => [
                ['spec_name' => 'Capacity', 'spec_value' => '80', 'spec_unit' => 'L'],
                ['spec_name' => 'Wheel', 'spec_value' => '400', 'spec_unit' => 'mm'],
                ['spec_name' => 'Frame', 'spec_value' => 'Steel', 'spec_unit' => null],
            ],
            'Motorová pila' => [
                ['spec_name' => 'Weight', 'spec_value' => '5200', 'spec_unit' => 'g'],
                ['spec_name' => 'Power', 'spec_value' => '2200', 'spec_unit' => 'W'],
                ['spec_name' => 'Bar Length', 'spec_value' => '400', 'spec_unit' => 'mm'],
                ['spec_name' => 'Chain Speed', 'spec_value' => '24', 'spec_unit' => 'm/s'],
                ['spec_name' => 'Warranty', 'spec_value' => '2', 'spec_unit' => 'years'],
            ],
            'Palice' => [
                ['spec_name' => 'Weight', 'spec_value' => '4500', 'spec_unit' => 'g'],
            ...
            'Nástrčný klíč' => [
                ['spec_name' => 'Weight', 'spec_value' => '850', 'spec_unit' => 'g'],
                ['spec_name' => 'Drive Size', 'spec_value' => '1/2', 'spec_unit' => 'inch'],
                ['spec_name' => 'Pieces', 'spec_value' => '12', 'spec_unit' => null],
                ['spec_name' => 'Material', 'spec_value' => 'Chrome Vanadium Steel', 'spec_unit' => null],
                ['spec_name' => 'Warranty', 'spec_value' => '3', 'spec_unit' => 'years'],
            ],
        ];
