...
class ReportService
{
    ...
    {
        return Cache::remember('reports.total_sales_per_country', self::REPORT_CACHE_TTL, function () {
    ...
    {
        return Cache::remember('reports.top10_products', self::REPORT_CACHE_TTL, function () {
    ...
    {
        return Cache::remember('reports.top10_categories', self::REPORT_CACHE_TTL, function () {
    ...
    public function getTotalSalesOfYears($startYear, $endYear, $driver)
    {
        return Cache::remember(
            ...
            function () use ($startYear, $endYear, $driver) {
    ...
    {
        return Cache::remember('reports.customers_by_country', self::REPORT_CACHE_TTL, function () {
