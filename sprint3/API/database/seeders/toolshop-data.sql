...
INSERT INTO `products` (`id`, `name`, `description`, `price`, `brand_id`, `category_id`, `product_image_id`, `is_location_offer`, `is_rental`)
...
INSERT INTO `invoices` (`id`, `first_name`, `last_name`, `invoice_date`, `invoice_number`, `billing_address`, `billing_city`, `billing_state`,
                        `billing_country`, `billing_postcode`, `total`, `payment_method`, `payment_account_name`,
                        `payment_account_number`, `created_at`)
VALUES (1, 'Jane', 'Doe', '2019-04-05 22:04:47', 'INV-2019000001', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '34.04',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (2, 'Jane', 'Doe', '2020-07-16 22:04:47', 'INV-2020000001', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '34.47',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (3, 'Jane', 'Doe', '2020-03-20 22:04:47', 'INV-2020000002', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '16.14',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (4, 'Jane', 'Doe', '2021-09-25 22:04:47', 'INV-2021000001', 'Test street 123', 'Brussels', 'Brussels', 'Belgium', '1122AB', '19.24',
        'Bank Transfer', 'Tester', '09876543ABC', NOW()),
       (5, 'Jane', 'Doe', '2021-10-30 22:04:47', 'INV-2021000002', 'Test street 123', 'Brussels', 'Brussels', 'Belgium', '1122AB', '27.11',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (6, 'Jane', 'Doe', NOW() - INTERVAL 3 DAY, 'INV-2022000001', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '20.14',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW()),
       (7, 'Jane', 'Doe', NOW() - INTERVAL 1 DAY, 'INV-2022000002', 'Test street 123', 'Utrecht', 'Utrecht', 'The Netherlands', '1122AB', '22.66',
        'Cash on Delivery', 'Tester', '09876543ABC', NOW());
